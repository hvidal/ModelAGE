...
bool InsideRect(float x, float y, float xa, float ya, float xb, float yb, float Erro)
{
    // Função que verifica se o ponto (x,y) está dentro do retangulo formado
    // pelos pontos (xa, ya) e (xb, yb).
    //
    //   (xa, ya)
    //    +-----------------+
    //    |      .          |
